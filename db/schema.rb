...
ActiveRecord::Schema.define(version: 20130604194244) do
  ...
  add_index "team_memberships", ["team_id", "player_id"], name: "index_team_memberships_on_team_id_and_player_id", unique: true, using: :btree
